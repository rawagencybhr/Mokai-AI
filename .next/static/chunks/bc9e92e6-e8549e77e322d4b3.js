"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{JU:function(){return iR},PL:function(){return so},QT:function(){return ss},ad:function(){return iM},cf:function(){return sc},hJ:function(){return iD},oe:function(){return sh},pl:function(){return sl},r7:function(){return su},vr:function(){return sm}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ss(e){e=iC(e,ik);let t=iC(e.firestore,iV);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ih({next:o=>{s.Za(),t.enqueueAndForget(()=>rP(e,a));let l=o.docs.has(n);!l&&o.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):l&&o.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(o)},error:e=>i.reject(e)}),a=new rz(e8(n.path),s,{includeMetadataChanges:!0,_a:!0});return rF(e,a)})(await iy(e),e.asyncQueue,t,n,r)),r.promise})(iO(t),e._key).then(n=>sf(t,e,n))}class sa extends se{constructor(e){super(),this.firestore=e}convertBytes(e){return new iF(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new ik(this.firestore,null,t)}}function so(e){e=iC(e,iN);let t=iC(e.firestore,iV),n=iO(t),r=new sa(t);return i7(e._query),(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new ih({next:n=>{s.Za(),t.enqueueAndForget(()=>rP(e,a)),n.fromCache&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):i.resolve(n)},error:e=>i.reject(e)}),a=new rz(n,s,{includeMetadataChanges:!0,_a:!0});return rF(e,a)})(await iy(e),e.asyncQueue,t,n,r)),r.promise})(n,e._query).then(n=>new si(t,r,e,n))}function sl(e,t,n){var r;e=iC(e,ik);let i=iC(e.firestore,iV),s=(r=e.converter)?n&&(n.merge||n.mergeFields)?r.toFirestore(t,n):r.toFirestore(t):t;return sd(i,[(function(e,t,n,r,i,s={}){let a,o;let l=e.Qu(s.merge||s.mergeFields?2:0,t,n,i);i0("Data must be an object, but it was:",l,r);let u=iJ(r,l);if(s.merge)a=new eo(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let r of s.mergeFields){let i=i1(t,r,n);if(!l.contains(i))throw new S(C.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);i9(e,i)||e.push(i)}a=new eo(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new i$(new eM(u),a,o)})(iW(i),"setDoc",e._key,s,null!==e.converter,n).toMutation(e._key,tD.none())])}function su(e,t,n,...r){e=iC(e,ik);let i=iC(e.firestore,iV),s=iW(i);return sd(i,[("string"==typeof(t=(0,h.m9)(t))||t instanceof iP?function(e,t,n,r,i,s){let a=e.Qu(1,t,n),o=[i1(t,r,n)],l=[i];if(s.length%2!=0)throw new S(C.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(i1(t,s[e])),l.push(s[e+1]);let u=[],c=eM.empty();for(let e=o.length-1;e>=0;--e)if(!i9(u,o[e])){let t=o[e],n=l[e];n=(0,h.m9)(n);let r=a.Nu(t);if(n instanceof iH)u.push(t);else{let e=iX(n,r);null!=e&&(u.push(t),c.set(t,e))}}return new iK(c,new eo(u),a.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):function(e,t,n,r){let i=e.Qu(1,t,n);i0("Data must be an object, but it was:",i,r);let s=[],a=eM.empty();return ee(r,(e,r)=>{let o=i3(t,e,n);r=(0,h.m9)(r);let l=i.Nu(o);if(r instanceof iH)s.push(o);else{let e=iX(r,l);null!=e&&(s.push(o),a.set(o,e))}}),new iK(a,new eo(s),i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tD.exists(!0))])}function sh(e){return sd(iC(e.firestore,iV),[new tB(e._key,tD.none())])}function sc(e,...t){var n,r,i;let s,a,o;e=(0,h.m9)(e);let l={includeMetadataChanges:!1,source:"default"},u=0;"object"!=typeof t[0]||iL(t[u])||(l=t[u],u++);let c={includeMetadataChanges:l.includeMetadataChanges,source:l.source};if(iL(t[u])){let e=t[u];t[u]=null===(n=e.next)||void 0===n?void 0:n.bind(e),t[u+1]=null===(r=e.error)||void 0===r?void 0:r.bind(e),t[u+2]=null===(i=e.complete)||void 0===i?void 0:i.bind(e)}if(e instanceof ik)a=iC(e.firestore,iV),o=e8(e._key.path),s={next:n=>{t[u]&&t[u](sf(a,e,n))},error:t[u+1],complete:t[u+2]};else{let n=iC(e,iN);a=iC(n.firestore,iV),o=n._query;let r=new sa(a);s={next:e=>{t[u]&&t[u](new si(a,r,n,e))},error:t[u+1],complete:t[u+2]},i7(e._query)}return function(e,t,n,r){let i=new ih(r),s=new rz(t,i,n);return e.asyncQueue.enqueueAndForget(async()=>rF(await iy(e),s)),()=>{i.Za(),e.asyncQueue.enqueueAndForget(async()=>rP(await iy(e),s))}}(iO(a),o,c,s)}function sd(e,t){return function(e,t){let n=new A;return e.asyncQueue.enqueueAndForget(async()=>r1(await ip(e).then(e=>e.syncEngine),t,n)),n.promise}(iO(e),t)}function sf(e,t,n){let r=n.docs.get(t._key),i=new sa(e);return new sn(e,i,t._key,r,new st(n.hasPendingWrites,n.fromCache),t.converter)}function sm(...e){return new iY("arrayUnion",e)}new WeakMap,function(e=!0){p=o.Jn,(0,o.Xd)(new l.wA("firestore",(t,{instanceIdentifier:n,options:r})=>{let i=t.getProvider("app").getImmediate(),s=new iV(new D(t.getProvider("auth-internal")),new V(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new S(C.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new ev(e.options.projectId,t)}(i,n),i);return r=Object.assign({useFetchStreams:e},r),s._setSettings(r),s},"PUBLIC").setMultipleInstances(!0)),(0,o.KN)(m,"4.7.3",void 0),(0,o.KN)(m,"4.7.3","esm2017")}()}}]);