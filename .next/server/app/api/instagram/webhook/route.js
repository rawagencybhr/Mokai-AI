"use strict";(()=>{var e={};e.id=654,e.ids=[654],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},9523:e=>{e.exports=require("dns")},2361:e=>{e.exports=require("events")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5158:e=>{e.exports=require("http2")},1808:e=>{e.exports=require("net")},2037:e=>{e.exports=require("os")},1017:e=>{e.exports=require("path")},7282:e=>{e.exports=require("process")},2781:e=>{e.exports=require("stream")},4404:e=>{e.exports=require("tls")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},1024:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>l,patchFetch:()=>g,requestAsyncStorage:()=>p,routeModule:()=>i,serverHooks:()=>c,staticGenerationAsyncStorage:()=>u});var s=t(9303),o=t(8716),a=t(670),n=t(9948);let i=new s.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/instagram/webhook/route",pathname:"/api/instagram/webhook",filename:"route",bundlePath:"app/api/instagram/webhook/route"},resolvedPagePath:"C:\\Users\\Abdulla Alshameeri\\Documents\\GitHub\\Mokai-AI\\app\\api\\instagram\\webhook\\route.ts",nextConfigOutput:"",userland:n}),{requestAsyncStorage:p,staticGenerationAsyncStorage:u,serverHooks:c}=i,l="/api/instagram/webhook/route";function g(){return(0,a.patchFetch)({serverHooks:c,staticGenerationAsyncStorage:u})}},9948:(e,r,t)=>{t.r(r),t.d(r,{GET:()=>u,POST:()=>c});var s=t(7070),o=t(3820),a=t(2188),n=t(6945),i=t(7597),p=t(6669);async function u(e){let{searchParams:r}=new URL(e.url),t=r.get("hub.mode"),o=r.get("hub.verify_token"),a=r.get("hub.challenge");return"subscribe"===t&&o===process.env.INSTAGRAM_VERIFY_TOKEN?new s.NextResponse(a,{status:200}):new s.NextResponse("Forbidden",{status:403})}async function c(e){try{let r=await e.json();if("instagram"===r.object){for(let e of r.entry)if(e.messaging)for(let r of e.messaging)await l(r);return new s.NextResponse("EVENT_RECEIVED",{status:200})}return new s.NextResponse("Not Found",{status:404})}catch(e){return console.error("Webhook Error:",e),new s.NextResponse("Internal Error",{status:500})}}async function l(e){let r=e.sender.id,t=e.recipient.id,s=e.message?.text;if(!s)return;let u=(0,o.hJ)(a.db,"bots"),c=(0,o.IO)(u,(0,o.ar)("instagramBusinessId","==",t)),l=await (0,o.PL)(c);if(l.empty)return;let g=l.docs[0].data();if(!g.isActive)return;let d=(0,p.k)(g,"",void 0,-1);try{let e=(0,n.PD)(),t=(await e.generateContent([{text:d},{text:s}])).response.text();if(!t)return;g.instagramAccessToken&&await (0,i.I)(g.instagramBusinessId,r,t,g.instagramAccessToken)}catch(e){console.error("Gemini Error:",e)}}},6669:(e,r,t)=>{t.d(r,{k:()=>a});let s=(e=50)=>e<=25?`🎭 الأسلوب (ودّي جداً - خوي):
