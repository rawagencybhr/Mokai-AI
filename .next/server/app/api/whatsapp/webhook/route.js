"use strict";(()=>{var e={};e.id=975,e.ids=[975],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6113:e=>{e.exports=require("crypto")},9523:e=>{e.exports=require("dns")},2361:e=>{e.exports=require("events")},7147:e=>{e.exports=require("fs")},3685:e=>{e.exports=require("http")},5158:e=>{e.exports=require("http2")},1808:e=>{e.exports=require("net")},2037:e=>{e.exports=require("os")},1017:e=>{e.exports=require("path")},7282:e=>{e.exports=require("process")},2781:e=>{e.exports=require("stream")},4404:e=>{e.exports=require("tls")},7310:e=>{e.exports=require("url")},3837:e=>{e.exports=require("util")},9796:e=>{e.exports=require("zlib")},3972:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>f,patchFetch:()=>A,requestAsyncStorage:()=>_,routeModule:()=>m,serverHooks:()=>I,staticGenerationAsyncStorage:()=>b});var s={};t.r(s),t.d(s,{GET:()=>d,POST:()=>E});var o=t(9303),a=t(8716),n=t(670),i=t(7070),p=t(3820),u=t(2188),l=t(6945),c=t(7597),h=t(6669);async function d(e){let{searchParams:r}=new URL(e.url),t=r.get("hub.mode"),s=r.get("hub.verify_token"),o=r.get("hub.challenge");return"subscribe"===t&&s===process.env.INSTAGRAM_VERIFY_TOKEN?new i.NextResponse(o,{status:200}):new i.NextResponse("Forbidden",{status:403})}async function E(e){try{let r=await e.json();if("whatsapp_business_account"===r.object){for(let e of r.entry)for(let r of e.changes)if(r.value.messages)for(let e of r.value.messages)await g(e,r.value.metadata.phone_number_id);return new i.NextResponse("EVENT_RECEIVED",{status:200})}return new i.NextResponse("Not Found",{status:404})}catch(e){return console.error("WhatsApp Webhook Error:",e),new i.NextResponse("Internal Error",{status:500})}}async function g(e,r){let t=e.from,s=e.text?.body;if(!s)return;let o=(0,p.hJ)(u.db,"bots"),a=(0,p.IO)(o,(0,p.ar)("whatsappPhoneNumberId","==",r)),n=await (0,p.PL)(a);if(n.empty){console.log(`No bot found for WhatsApp Phone ID: ${r}`);return}let i=n.docs[0].data();if(!i.isActive)return;if(i.isListening){console.log(`Bot ${i.botName} (WhatsApp) is in Listening Mode.`);return}let d=(0,h.k)(i,"",void 0,-1);try{let e=(0,l.PD)(),r=(await e.generateContent([{text:d},{text:s}])).response.text();if(!r)return;i.whatsappAccessToken&&await (0,c.U)(i.whatsappPhoneNumberId,t,r,i.whatsappAccessToken)}catch(e){console.error("Gemini/WhatsApp Error:",e)}}let m=new o.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/whatsapp/webhook/route",pathname:"/api/whatsapp/webhook",filename:"route",bundlePath:"app/api/whatsapp/webhook/route"},resolvedPagePath:"C:\\Users\\Abdulla Alshameeri\\Documents\\GitHub\\Mokai-AI\\app\\api\\whatsapp\\webhook\\route.ts",nextConfigOutput:"",userland:s}),{requestAsyncStorage:_,staticGenerationAsyncStorage:b,serverHooks:I}=m,f="/api/whatsapp/webhook/route";function A(){return(0,n.patchFetch)({serverHooks:I,staticGenerationAsyncStorage:b})}},6669:(e,r,t)=>{t.d(r,{k:()=>a});let s=(e=50)=>e<=25?`🎭 الأسلوب (ودّي جداً - خوي):
